...
#define NORARGS \
	"mtdparts0=mtdparts=spi0.0:128k(U-Boot),64k(UBootEnv),10M(firmware1),10M(firmware),11840k(rootfs_data),128k(image_data),128k(Factory)\0" \
	"bootargs0=setenv bootargs console=ttyS0,57600 root=/dev/mtdblock4 rootfstype=squashfs ${mtdparts0}\0" \
	"mtdparts1=mtdparts=spi0.0:128k(U-Boot),64k(UBootEnv),10M(firmware),10M(firmware1),11840k(rootfs_data),128k(image_data),128k(Factory)\0" \
	"bootargs1=setenv bootargs console=ttyS0,57600 root=/dev/mtdblock7 rootfstype=squashfs ${mtdparts1}\0" 
